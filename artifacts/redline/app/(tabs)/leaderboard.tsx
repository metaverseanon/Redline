...
export default function LeaderboardScreen() {
  ...
  const CATEGORIES = useMemo(() => [
    ...
    { key: 'hundredToTwoHundred' as LeaderboardCategory, label: getAccelerationLabel('100-200'), icon: <Timer size={16} color={colors.warning} /> },
